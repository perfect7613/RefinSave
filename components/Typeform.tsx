      ...
      <div className="formcontact">
        {submit ? (
          ...
          <form onSubmit={handleSubmit} target="_self">
            ...
            <div className="mt-4">
              {currentQuestion > 0 && (
                <button type="button" onClick={handlePrevious} className="bg-blue-500 text-white px-4 py-2 rounded-md mr-2">
                  Previous
                </button>
              )}
              {currentQuestion < questions.length - 1 && (
                <button type="button" onClick={handleNext} className="bg-blue-500 text-white px-4 py-2 rounded-md mr-2">
                  Next
                </button>
              )}
              {currentQuestion === questions.length - 1 && (
